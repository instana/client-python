...
class LoggingAnalyzeApi:
    ...
    def get_log_volume_usage(
        ...
        grouping_tag: Annotated[Optional[StrictStr], Field(description="Optional tag to group volume usage by.")] = None,
        ...
        Returns aggregated log volume usage data for a specified time range and optional grouping tag. `fromTs` and `toTs` are required and must define a valid time range (i.e., `fromTs` <= `toTs`). Valid groupingTag`s are: kubernetes_cluster_name, kubernetes_daemonset_name, kubernetes_namespace_name, kubernetes_deployment_name, host_name, zone. 
        ...
        :type to_ts: int
        :param grouping_tag: Optional tag to group volume usage by.
