...
class WebsiteConfigurationApi:
    ...
    def post_website_source_map_upload_config(
        self,
        website_id: Annotated[StrictStr, Field(description="Website ID")],
        source_map_upload_configs: Optional[SourceMapUploadConfigs] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param website_id: Website ID (required)
        :type website_id: str
        :param source_map_upload_configs:
        :type source_map_upload_configs: SourceMapUploadConfigs
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_website_source_map_upload_config_serialize(
            website_id=website_id,
            source_map_upload_configs=source_map_upload_configs,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _post_website_source_map_upload_config_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if source_map_upload_configs is not None:
            _body_params = source_map_upload_configs
