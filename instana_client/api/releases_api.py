...
class ReleasesApi:
    ...
    def get_all_releases(
        self,
        var_from: Annotated[Optional[StrictInt], Field(description="The timestamp from where one wants to fetch the release markers.")] = None,
        to: Annotated[Optional[StrictInt], Field(description="The timestamp till where one wants to fetch the release markers.")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="The maximum number of release markers to be fetched")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: The timestamp from where one wants to fetch the release markers.
        :type var_from: int
        :param to: The timestamp till where one wants to fetch the release markers.
        :type to: int
        :param max_results: The maximum number of release markers to be fetched
