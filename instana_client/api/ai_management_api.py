...
class AIManagementApi:
    ...
    def delete_llm_egress_gateway(
        self,
        id: Annotated[StrictStr, Field(description="LLM egress gateway ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: LLM egress gateway ID (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def update_llm_egress_gateway(
        self,
        id: Annotated[StrictStr, Field(description="LLM egress handler ID")],
        llm_egress_gateway: LLMEgressGateway,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: LLM egress handler ID (required)
        :type id: str
        :param llm_egress_gateway: (required)
        :type llm_egress_gateway: LLMEgressGateway
        :param _request_timeout: timeout setting for this request. If one
