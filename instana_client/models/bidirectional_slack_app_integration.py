...
class BidirectionalSlackAppIntegration(AbstractIntegration):
    ...
    __properties: ClassVar[List[str]] = ["id", "kind", "name", "testEventType", "testSeverity", "testState", "timezone", "appId", "channelId", "channelName", "emojiRendering", "status", "teamId", "teamName"]
