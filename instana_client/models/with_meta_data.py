...
class WithMetaData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "completeTagFilterExpression", "created", "customPayloadFields", "description", "displayUrl", "enabled", "gracePeriod", "granularity", "id", "initialCreated", "mobileAppId", "name", "readOnly", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold", "triggering"]
