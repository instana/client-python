...
class BrowserScriptConfiguration(SyntheticTypeConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "browser", "fileName", "github", "profiles", "recordVideo", "script", "scriptType", "scripts"]
