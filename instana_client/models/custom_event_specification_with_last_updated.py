...
class CustomEventSpecificationWithLastUpdated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actions", "applicationAlertConfigId", "deleted", "description", "displayUrl", "enabled", "entityType", "expirationTime", "id", "infraAlertConfigId", "lastUpdated", "migrated", "name", "query", "ruleLogicalOperator", "rules", "transientEventAlertMuted", "transientEventEnabled", "transientEventThreshold", "triggering"]
