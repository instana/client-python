...
class ServiceLevelsAlertConfigWithRBACTag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "apdexIds", "burnRateConfig", "burnRateTimeWindows", "created", "customPayloadFields", "description", "displayUrl", "enabled", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "sloIds", "threshold", "timeThreshold", "triggering"]
