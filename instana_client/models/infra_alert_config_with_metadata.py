...
class InfraAlertConfigWithMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "created", "customPayloadFields", "description", "displayUrl", "enabled", "evaluationType", "gracePeriod", "granularity", "groupBy", "id", "initialCreated", "name", "readOnly", "rule", "ruleLogicalOperator", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold", "triggering"]
