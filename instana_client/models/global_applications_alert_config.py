...
class GlobalApplicationsAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "applications", "boundaryScope", "customPayloadFields", "description", "evaluationType", "gracePeriod", "granularity", "groupBy", "includeInternal", "includeSynthetic", "name", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold", "triggering"]
