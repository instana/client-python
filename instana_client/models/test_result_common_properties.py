...
class TestResultCommonProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clientId", "customTags", "dnsLookup", "dnsQueryType", "dnsServerName", "dnsTransport", "errors", "gitCommit", "gitHubUrl", "icmpPacketCount", "icmpPacketInterval", "icmpPacketSize", "icmpPacketTimeout", "icmpTargetHost", "id", "ismDetails", "lastErrors", "locationDisplayLabel", "locationId", "profile", "runType", "sslDaysRemaining", "sslHostname", "testCommonProperties", "testId", "testLastError", "testName"]
