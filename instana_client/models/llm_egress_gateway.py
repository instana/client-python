...
class LLMEgressGateway(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aiModel", "createdAt", "description", "endpointApiKey", "endpointUrl", "id", "instanaAgents", "metadata", "modifiedAt", "name", "prompt", "supports", "tenantUnitId", "watsonxKey", "watsonxProject", "watsonxUrl"]
