...
class WebsiteAlertConfigWithRBACTag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "created", "customPayloadFields", "description", "displayUrl", "enabled", "gracePeriod", "granularity", "id", "initialCreated", "name", "rbacTags", "readOnly", "rule", "rules", "severity", "tagFilterExpression", "tagFilters", "threshold", "timeThreshold", "triggering", "websiteId"]
