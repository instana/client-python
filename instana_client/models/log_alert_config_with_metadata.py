...
class LogAlertConfigWithMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "created", "customPayloadFields", "description", "displayUrl", "enabled", "gracePeriod", "granularity", "groupBy", "id", "initialCreated", "name", "readOnly", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold"]
