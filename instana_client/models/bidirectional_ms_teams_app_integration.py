...
class BidirectionalMsTeamsAppIntegration(AbstractIntegration):
    ...
    __properties: ClassVar[List[str]] = ["id", "kind", "name", "testEventType", "testSeverity", "testState", "timezone", "apiTokenId", "channelId", "channelName", "instanaUrl", "serviceUrl", "teamId", "teamName", "tenantId", "tenantName"]
