...
class SyntheticAlertConfigWithRBACTag(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affectedLocationsCount", "alertChannelIds", "created", "customPayloadFields", "description", "displayUrl", "enabled", "evaluationType", "gracePeriod", "id", "includeOnDemand", "initialCreated", "name", "rbacTags", "readOnly", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
