...
class ApiTeamScope(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessPermissions", "actionFilter", "applications", "businessPerspectives", "infraDfqFilter", "kubernetesClusters", "kubernetesNamespaces", "logFilter", "mobileApps", "restrictedApplicationFilter", "syntheticCredentials", "syntheticTests", "tagIds", "websites"]
