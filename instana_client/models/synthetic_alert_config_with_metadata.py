...
class SyntheticAlertConfigWithMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affectedLocationsCount", "alertChannelIds", "created", "customPayloadFields", "description", "displayUrl", "enabled", "evaluationType", "gracePeriod", "id", "includeOnDemand", "initialCreated", "name", "readOnly", "rule", "severity", "syntheticTestIds", "tagFilterExpression", "timeThreshold"]
