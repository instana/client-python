...
class ApplicationAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "applicationId", "applications", "boundaryScope", "customPayloadFields", "description", "enabled", "evaluationType", "gracePeriod", "granularity", "groupBy", "includeInternal", "includeSynthetic", "name", "rule", "rules", "severity", "tagFilterExpression", "tagFilters", "threshold", "timeThreshold", "triggering"]
